...
function setup(){
  ...
  //create MagicalBook
  MagicalBook = createSprite(windowWidth-1100, windowHeight-70, 20, 60);
  ...
  swal({
    title: `Story!${"\n"}`,
    text: "Once there is writer and he writes horror stories which come to life if they open the books, so for this reason he keeps all of his books locked, he writes them with a magical typewirter, so one day one of the the book gets opened. Then all the monsters come out of the book and haunt everyone, so If this has to stop then the monsters should go back in the book, so the magical book must go in search for the enchanted typewirter for an alternate ending so that all the monsters go back.... ",
